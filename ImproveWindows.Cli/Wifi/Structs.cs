...
namespace ImproveWindows.Cli.Wifi
{
    //= BASIC =========================================================================================
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct Dot11BssidList
    {
        // always process and pass as IntPtr, never interop directly
    ...
    public struct WlanInterfaceCapability
    {
        ...
        [MarshalAs(UnmanagedType.Bool)] public bool DSupported;
    ...
    public struct WlanMsmNotificationData
    {
        ...
        public Dot11MacAddress MacAddress;
        [MarshalAs(UnmanagedType.Bool)] public bool SecurityEnabled;
        [MarshalAs(UnmanagedType.Bool)] public bool FirstPeer;
        [MarshalAs(UnmanagedType.Bool)] public bool LastPeer;
        public WlanReasonCode ReasonCode;
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct WlanRawDataListHeader
    {
        // originally WlanRawDataList
        public uint TotalSize;
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct WlanRawDataList
    {
        // always process and pass as IntPtr, never interop directly
